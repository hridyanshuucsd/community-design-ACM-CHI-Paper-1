...
- **Formative study:** N=20–24, semi-structured interviews + one co-design workshop, community members + 2–3 planning professionals, San Diego, needs-finding → numbered design goals (BoundarEase/Graphologue-style traceability).
...
1. **Hook + stakes.** A concrete vignette: a rezoning proposal, a comment period, a community that can react but not author. Ground in Arnstein's Ladder — most digital civic tools sit at rungs 3–5 (inform/consult), per the Luo et al. 2025 review's 16.7% co-developer statistic.
...
- Semi-structured interviews (protocol in Supplementary §S2) + one half-day co-design workshop with a subset (n≈10–12), following the BoundarEase two-phase formative/evaluative structure and the Sassmannshausen et al. low-fidelity prototyping precedent (paper/clay/cardboard massing before any software).
...
- Thematic saturation reached by participant ~18–20 (report a saturation curve, per current qualitative-methods norms).
...
- **Module 3 (Condition C only): solution-centered suggestion generation.** Proactive generation of 2–3 concrete, compliant alternative massings/unit-mixes the group can preview, accept, remix, or reject — directly extending Prototyping Dynamics' "share multiple" mechanism from marketing-ad dyads to zoning-constrained building groups.
...
- Re-run a Digital-Modeling-for-Everyone-style Wizard-of-Oz elicitation with **non-expert community members** (not CAD-literate professionals, unlike Khan & Tunçer), N≈15–18 drawn partly from the formative-study pool, thematically analyzed for selection strategies, axis-convention assumptions, and "implicit construction" phrasing.
...
- Offline benchmark: N utterances (target 250–400) collected from the elicitation study, hand-labeled with intended edit; measure task-level execution accuracy of the voice-to-scene-edit pipeline.
...
**Condition C — Solution-centered AI co-design.** Adds Module 3: proactive generation of 2–3 concrete compliant alternatives the group can preview/accept/remix/reject, on top of everything in B.
